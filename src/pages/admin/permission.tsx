...
import { colorMethod, isSuccessResponse } from "@/config/utils";
...
const PermissionPage = () => {
                ...
                <Space>
                    ...
                    >
                        <Popconfirm
                            ...
                            onConfirm={() => handleDeletePermission(String(entity.id))}
                            okText="Xác nhận"
                            cancelText="Hủy"
                        >
    ...
    const buildQuery = (params: any, sort: any, filter: any) => {
        ...
        let sortBy = "";
        const fields = ["id", "name", "method", "module", "createdAt", "updatedAt"];
    ...
    return (
        <div>
            <Access
                permission={ALL_PERMISSIONS.PERMISSION.GET_ALL}
            >
