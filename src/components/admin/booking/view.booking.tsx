        ...
        <>
            ...
            >
                <Descriptions title="" bordered column={2} layout="vertical">
                    ...
                    <Descriptions.Item label="Giảm giá">{dataInit?.discount ?? 'N/A'}</Descriptions.Item>
                    <Descriptions.Item label="Tạm tính">{dataInit?.subtotal ? formatCurrency(dataInit.subtotal) : 'N/A'}</Descriptions.Item>
                    <Descriptions.Item label="Tổng tiền">{dataInit?.totalAmount ? formatCurrency(dataInit.totalAmount) : 'N/A'}</Descriptions.Item>
